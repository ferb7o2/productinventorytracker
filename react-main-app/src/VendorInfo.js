            ...
            <div className="container">
                    ...
                    <div className='row'>
                        <table className="table table-striped">
                            ...
                            <tbody>
                                {transaction_data.map(({tId,tpId, date,vId,purchaseInvoiceId, purchaseWeight, purchasePrice,saleInvoiceId,saleWeight, salePrice},i)=>
                                    ({vId}.vId)!== null?
                                        ...
                                        vId_global==(transaction_data[i].vId) ? 
                                            <tr>
                                                ...
                                                <td>{nameForId(ProductData, transaction_data[i].tpId)}</td>
